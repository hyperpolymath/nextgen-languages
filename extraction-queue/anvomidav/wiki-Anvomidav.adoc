...
Anvomidav combines linear types, session types, and dependent types to
provide maximum formal guarantees for hard real-time systems. Every
resource is tracked, every protocol is verified, every deadline is
