...
AffineScript combines multiple advanced type system features into a
cohesive language targeting WebAssembly:
...
AffineScript explores how advanced type theory can be made practical. By
combining affine types (resource safety without GC), dependent types
(precise specifications), and effect tracking (purity guarantees), it
enables verified software components that run anywhere WebAssembly runs.
...
* [[WebAssembly Backend]]
* [link:#effect-system[Effect System]]
* [[Linear Types]]
