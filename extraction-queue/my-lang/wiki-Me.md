...
> Visual, playful introduction to programming
...
**Every action has a visible, immediate result.**
...
|---------|----------------|
| Sequence | Stacked blocks |
| Repetition | Loop blocks with count |
| Conditionals | Fork-in-road blocks |
...
The Me environment runs in a web browser. Visit the playground:
