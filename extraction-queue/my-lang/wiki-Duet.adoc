...
Duet extends Solo with AI-assisted features, enabling a collaborative
relationship between human programmers and AI systems. Designed for ages
11-14.
...
See [[NEUROSYM.scm]] for details on how Duet bridges neural and symbolic
AI.
