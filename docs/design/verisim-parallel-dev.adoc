...
|7-11 |HTTP API implementation, normalizer scaffolding |Hexad layer + VCL execution engine
...
- [ ] VCL execution engine functional
- [ ] Test coverage > 80%
- [ ] QUICKSTART guide complete
...
|FBQL/VCL integration infeasible |Medium
...
* link:~/Documents/hyperpolymath-repos/verisim/README.adoc[VeriSimDB README]
* link:~/Documents/hyperpolymath-repos/verisim/STATE.scm[VeriSimDB STATE.scm]
* link:~/Documents/hyperpolymath-repos/verisim/ECOSYSTEM.scm[VeriSimDB ECOSYSTEM.scm]
