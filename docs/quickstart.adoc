...
* **VeriSimDB STATE**: link:~/Documents/hyperpolymath-repos/verisim/STATE.scm[verisim/STATE.scm]
* **FormBD ECOSYSTEM**: link:~/Documents/hyperpolymath-repos/formbd/ECOSYSTEM.scm[formbd/ECOSYSTEM.scm]
* **VeriSimDB ECOSYSTEM**: link:~/Documents/hyperpolymath-repos/verisim/ECOSYSTEM.scm[verisim/ECOSYSTEM.scm]
...
* **VeriSimDB Whitepaper**: link:~/Documents/hyperpolymath-repos/verisim/WHITEPAPER.md[verisim/WHITEPAPER.md]
* **VCL Grammar**: link:~/Documents/hyperpolymath-repos/verisim/docs/vcl-grammar.ebnf[verisim/docs/vcl-grammar.ebnf]
