...
This coordinator tracks the language family, the KitchenSpeak DSL and Firmboot's
continuity research prototype, each maintained as its own standalone repo (no
language code lives here). In the existing integration record, 11 languages are
...
| **Firmboot** | TBD | TBD | TBD | TBD | TBD | Research prototype: checked Agda/Lean models and Elixir reference runner. See https://github.com/hyperpolymath/firmboot/blob/main/VERIFICATION.md[evidence and limits]. No readiness grade or BoJ integration is claimed.
