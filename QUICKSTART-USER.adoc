...
// Replace nextgen-languages, Nextgen Languages — See README.adoc for details., just run, Nextgen Languages started successfully. with actuals
= nextgen-languages — Quick Start for Users
:toc:
:toclevels: 2

== What is nextgen-languages?

Nextgen Languages — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./nextgen-languages-portable
----
...
[source]
----
Nextgen Languages started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/nextgen-languages/wiki
